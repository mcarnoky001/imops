define([
	...
	"dojo/dom-style",
	"dojo/dom"
], function(declare, lang, win, on, domClass, domGeom, WidgetBase, touch, domStyle, dom) {
	...
	return declare(WidgetBase, {
		...
		setSidePaneCloseCSS : function() {
			var appRoot = dom.byId("appRoot").children[0];
			var css = {
				"webkit-transform" : "translate3d(-100%, 0px, 0px)",
				"transform" : "translate3d(-100%, 0px, 0px)",
				"-moz-transition" : "-moz-transform 0.4s ease-in-out",
				"-webkit-transition" : "-webkit-transform 0.4s ease-in-out",
				"-ms-transition" : "-mstransform 0.4s ease-in-out",
			...
			domStyle.set(this.domNode, css);
			for (var i = 0; i < appRoot.children.length; i++) {
				if (appRoot.children[i] && !domClass.contains(appRoot.children[i], "header")) {
					domStyle.set(appRoot.children[i], css2);
				}
			}
		},
		setSidePaneOpenCSS : function() {
			var appRoot = dom.byId("appRoot").children[0];
			var css = {
				"webkit-transform" : "translate3d(0px, 0px, 0px)",
				"transform" : "translate3d(0px, 0px, 0px)",
