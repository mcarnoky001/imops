define([
	...
	"gjax/log/level",
	"dojo/dom-style"
], function(_HasDropDown, lang, on, touch, keys, level, domStyle) {
	...
	var origOpenDropDown = _HasDropDown.prototype.openDropDown;
	...
	_HasDropDown.extend({
		...
		openDropDown: function(){
			//when autoWidth is true and narrow dropDown is expanded to match widget, all following dropDowns
			//on this widget would be of same width, even if they contain longer items
			if (this.autoWidth && this.dropDown && domStyle.get(this.dropDown.domNode, "width")) {
				domStyle.set(this.dropDown.domNode, "width", null);
			}
			return origOpenDropDown.apply(this, arguments);
		}
