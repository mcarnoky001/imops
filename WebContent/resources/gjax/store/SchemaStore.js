	...
	var SchemaStore = declare(null, {
		...
		callCustom : function(methodName, objOrId, objectOrQuery, options) {
			...
			function _callCustomMethod(smd, customMethod, methodName, objOrId, object, options) {
				...
				var headers = lang.mixin({}, this.headers, options.headers, customMethod.isList ? this._buildPagingHeaders(options) : null);
				...
				var query = null;
				if (customMethod.method == "post" || customMethod.method == "put") {
		...
		query : function(query, options) {
			...
			//		If SMD defines only one template (in property 'template'), this temlate will be used to build the query by feeding the template using query obj and options
			//		If SMD defines multiple templates (in property 'templates'), query object or options object must contain property '_tamplate' which defines template name.
			// query: Object|String
			...
			this._ensureSchema(options).then(lang.hitch(this, function(smd) {
				...
				var headers = lang.mixin({}, this.headers, options.headers, this._buildPagingHeaders(options));
		...
		_buildQueryDefinition : function(query, options, definitions, useOptionOperators) {
			...
			if (isEmptyQ && isEmptyT) {
				...
				return {
					...
					query : "?" + rqlTemplate.feed(tmpl, query, options)
				};
		...
		_buildPagingHeaders : function(options) {
			var pagingHeaders = {};
