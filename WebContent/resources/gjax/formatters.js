...
define([
	...
	"gjax/XString", "dojo/date/locale"
], function(kernel, dateLocale, dateStamp, number, currency, Deferred, lang, config, when, encHtml, stringUtils) {
	...
	function _dateTimeFormatter(options, value, rowIdx, cell) {
		...
		return value != null ? dateLocale.format(value, options) : "";
	}
