define([
	...
	function checkEllipsis(evt) {
		...
		if (cell.element && !(cell.column && cell.column.titleFormatter)) { // ignore cells with manual title (via titleFormatter)
			var _isEllipsisActive = isEllipsisActive(cell.element);
			domAttr.set(cell.element, "title", _isEllipsisActive ? domProp.get(cell.element, "textContent") : "");
